 ...
 *◦ Fecha:* ${date}
 *◦ Hora:* ${time}`
conn.sendHydrated(m.chat, retext, 'No olvides tu *codigo* por qué sera necesario para futuras actuaciones', apii.data, 'https://github.com/g4tito/lolibot-md', 'Github', null, null, [['🐱 CREADOR', `${usedPrefix}creador`], ['🥮 MENU', `${usedPrefix}menu`]], m)
